export const projectsData = [
  ...
  },
  {
    ...
    title: 'Game Sort',
    description:
      'A web application for finding your next favorite game to play.',
    image: './game-sort.png',
    tech: ['React', 'MaterialUI', 'Python'],
  ...
  },
  {
    ...
    description: 'A web application for tracking your budget.',
  ...
  },
  {
    ...
    title: 'Spreaddit',
    description:
      'A mobile application that allows you to efficiently upload the same post to multiple communities on reddit.',
    image: './spreaddit.png',
